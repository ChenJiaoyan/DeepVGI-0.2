...
for i in range(0, inLayerDefn.GetFieldCount()): # inLayerDefn.GetFieldCount()
    fieldDefn = inLayerDefn.GetFieldDefn(i)
    outlayer.CreateField(fieldDefn)
outLayerDefn = outlayer.GetLayerDefn()

for i in range(0, layer.GetFeatureCount()): #layer.GetFeatureCount()
